...
def newyork():
  ...
  #i01.mouth.speakBlocking(u"Начать распространять новости")
  i01.setHeadSpeed(0.85,0.85)
  ...
  #i01.mouth.speakBlocking(u"Я уезжаю сегодня")
  i01.moveHead(160,68)
  i01.moveArm("left",5,86,30,10)
  i01.moveArm("right",86,140,83,80)
  i01.moveHand("left",99,140,173,167,130,26)
  ...
  #i01.mouth.speakBlocking(u"Я хочу быть частью этого")
  i01.moveHead(138,86)
  ...
  #i01.mouth.speakBlocking(u"Если я смогу сделать это там")
  i01.moveHead(160,86)
  ...
  #i01.mouth.speakBlocking(u"Я сделаю это где угодно")
  i01.moveHead(160,86)
  i01.moveArm("left",80,128,71,62)
  i01.moveArm("right",80,132,69,80)
  i01.moveHand("left",45,40,30,25,35,90)
  ...
  #i01.mouth.speakBlocking(u"Тебе решать")
  i01.moveHead(160,86)
