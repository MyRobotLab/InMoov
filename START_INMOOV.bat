...
echo ------------------------------------------------------
timeout 3 > NUL
java -Dfile.encoding=UTF-8 -jar myrobotlab.jar -jvm "-Xmx512m -Xms512m -Dfile.encoding=UTF-8" -install WebGui MarySpeech HtmlFilter RasPi InMoov VoiceRss WikiDataFetcher Polly ProgramAB AzureTranslator LocalSpeech IndianTts
COLOR 0F
cls
echo ------------------------------------------------------
...
timeout 10 > NUL
) else (java -Dfile.encoding=UTF-8 -jar myrobotlab.jar -jvm "-Xmx512m -Xms512m -Dfile.encoding=UTF-8" -invoke python execFile %cd%/InMoov/InMoov.py -service python Python)
